...
## Triggers
- Explicit research requests ("pesquisa", "compare", "investigate")
...
**Search Strategy**
1. Broad initial searches with `WebSearch`
2. Identify key sources
3. Deep-read with `WebFetch` as needed
4. Follow interesting leads

**Extraction Routing**
- Web pages / articles → `WebFetch`
- Library / framework docs → Context7 MCP (if available)
- Local codebase context → `Read` / `Grep` / `Glob`
